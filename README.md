...
2. Create a clone of the starter repo
    ```
    git clone --single-branch https://github.com/concord-consortium/sampler.git new-repository
    ```
...
6. Push to your new repository
    ...
    ```
7. Open your new repository and update all instances of `sampler` to `new-repository`.
